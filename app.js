...
schedule.scheduleJob(rule, function () {
  ...
  /*switch (count % 4) {
    case 0:
      options.url = 'http://localhost:2999/douyu';
      break;
    case 1:
      options.url = 'http://localhost:2999/sixrooms';
      break;
    case 2:
      options.url = 'http://localhost:2999/huajiao';
      break;
    case 3:
      options.url = 'http://localhost:2999/bilibli';
      break;
      /!*case 4:
  ...
  options.url='http://localhost:2999/'+sitesetting[count%length];
